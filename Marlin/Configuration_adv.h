 ...
 */
#define E0_AUTO_FAN_PIN 8  //- Peter: war -1
 ...
 */
//#define CASE_LIGHT_ENABLE //- Peter: war auskommentiert
#if ENABLED(CASE_LIGHT_ENABLE)
  #define CASE_LIGHT_PIN 11                  // Override the default pin if needed //- Peter: war auskommentiert und 4
